Feature: Basic Book-Store
  ...
  Scenario: Add 'x' to author
    Given I'm home
    Given it contains the book "J.R.R. Tolkien: The Lord Of The Rings"
    When I click on book-up 2
    Then it contains the book "J.R.R. Tolkienx: The Lord Of The Rings"

  Scenario: Go to book
    Given I'm home
    Given it contains the book "J.R.R. Tolkienx: The Lord Of The Rings"
    When I click on "J.R.R. Tolkienx: The Lord Of The Rings"
    Then the url should have path "/books/2"
